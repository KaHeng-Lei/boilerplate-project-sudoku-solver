...
const server = "https://boilerplate-project-sudoku-solver.kaheng-lei.repl.co";
...
suite("Functional Tests", () => {
  ...
  test("Check a puzzle placement with multiple placement conflicts: POST request to /api/check", function (done) {
    chai
      .request(server)
      .post("/api/check")
      .send({ puzzle: validPuzzle, coordinate: "B1", value: "6" })
      .end(function (err, res) {
        assert.equal(res.status, 200);
        assert.equal(res.body.valid, false);
  ...
  test("Check a puzzle placement with invalid characters: POST request to /api/check", function (done) {
    chai
      ...
      .send({
        puzzle:
          "1.5..2.A4..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.",
        coordinate: "A2",
        value: "2",
      })
      .end(function (err, res) {
  ...
  test("Check a puzzle placement with incorrect length: POST request to /api/check", function (done) {
    chai
      ...
      .send({
        puzzle:
          "1.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.9",
        coordinate: "A2",
        value: "2",
      })
      .end(function (err, res) {
  ...
  test("Check a puzzle placement with invalid placement coordinate: POST request to /api/check", function (done) {
    chai
      .request(server)
      .post("/api/check")
      .send({ puzzle: validPuzzle, coordinate: "A02", value: "2" })
      .end(function (err, res) {
        assert.equal(res.status, 200);
